...
from models import OptimizedOpportunity
from utils import add_optimized_opportunity
from sentence_transformers import SentenceTransformer
from OptimizedXMLScanner import documents
...
with app.app_context():
    ...
    for i in range(len(documents)):
        ...
        add_optimized_opportunity(opportunity_id, page_content, embedding_vector)
